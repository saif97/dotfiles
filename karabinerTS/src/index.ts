...
writeToProfile(
	...
	[
		...
		rule("General").manipulators([
			...
			map("non_us_backslash").to("left_command", ["control"]).toIfAlone("non_us_backslash"),
			...
			mapWithAnyMod("right_option").to("right_option").toIfAlone("f12", ["fn"]),
		...
		rule("QWERTY to Colemak for VMs").manipulators([
			withCondition(ifApp([APP_ID_UTM, "org.cirruslabs.tart", "com.microsoft.rdc.macos"]))([
				// Top row
				mapWithAnyMod("e").to("f"),
				mapWithAnyMod("r").to("p"),
				mapWithAnyMod("t").to("g"),
				mapWithAnyMod("y").to("j"),
				mapWithAnyMod("u").to("l"),
				mapWithAnyMod("i").to("u"),
				mapWithAnyMod("o").to("y"),
				mapWithAnyMod("p").to("semicolon"),
				// Home row
				mapWithAnyMod("s").to("r"),
				mapWithAnyMod("d").to("s"),
				mapWithAnyMod("f").to("t"),
				mapWithAnyMod("g").to("d"),
				mapWithAnyMod("j").to("n"),
				mapWithAnyMod("k").to("e"),
				mapWithAnyMod("l").to("i"),
				mapWithAnyMod("semicolon").to("o"),
				// Bottom row
				mapWithAnyMod("n").to("k"),
			]),
		]),
	],
	{
