...
If the Agent tool is unavailable in this context, work through all four angles
yourself, in this same context, in one pass — do not skip an angle for lack of
fan-out. Say clearly in your summary that this was a single-pass review, not the
full 4-agent fan-out, so whoever reads it isn't misled about what actually ran.
