...
function M.setupNvim()
	...
	map_key("n", "<leader>gi", function() picker.gh_issue() end, { desc = "GitHub Issues (open)" })
	map_key("n", "<leader>gI", function() picker.gh_issue({ state = "all" }) end, { desc = "GitHub Issues (all)" })
	map_key("n", "<leader>gp", function() picker.gh_pr() end, { desc = "GitHub Pull Requests (open)" })
	map_key("n", "<leader>gP", function() picker.gh_pr({ state = "all" }) end, { desc = "GitHub Pull Requests (all)" })
